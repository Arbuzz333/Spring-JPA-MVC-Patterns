...
import avahidov.mappers.HintEntityItemMapper;
...
public abstract class AbstractTest {
    ...
    protected User generateCustomTimeUser() {
        User user = mapper.userItemToHintUserEntity(generateCustomTimeUserEntity());
        return user;
    }

    protected HintUserEntity generateCustomTimeUserEntity() {
        ...
        businessOpEntity.setCode(CODE_OP_HP + nano + "_" + generatingRandomAlphabeticString());
        ...
        stepEntity.setCode("code_step_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        stepEntity2.setCode("code2_step_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        channelEntity.setCode("code_channel_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        channelEntity2.setCode("code2_channel_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        hintEntity.setCode("code_hint_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        hintEntity2.setCode("code2_hint_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        hintEntity3.setCode("code3_hint_HP_" + nano + "_" + generatingRandomAlphabeticString());
        ...
        hintEntity4.setCode("code4_hint_HP_" + nano + "_" + generatingRandomAlphabeticString());
    ...
    public String generatingRandomAlphabeticString() {
        ...
        String generatedString = random.ints(aIndex, zIndex + 1)
